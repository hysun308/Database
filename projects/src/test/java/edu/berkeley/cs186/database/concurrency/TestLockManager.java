...
public class TestLockManager {
  ...
  public void testSimpleExclusiveLock() throws InterruptedException{
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testSharedUpgradeExclusiveSameTransactionLockManager() throws InterruptedException{
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testExclusiveThenSharedSameTransactionLockManager() throws InterruptedException{
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testReleaseLockLockManager () throws  InterruptedException{
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testNonEligibleUpgrade() throws InterruptedException{
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    assertTrue("Transaction 1 Second Thread should not have finished", thread3.isAlive()); //T1 should be waiting on T2

    assertFalse(lockMan.holdsLock("A", 1, LockManager.LockType.EXCLUSIVE)); //T1 should not have Exclusive lock
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testExclusiveThenSharedTwoTransaction() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    assertFalse(lockMan.holdsLock("A", 2, LockManager.LockType.SHARED)); //T2 did not obtain shared lock
    ...
    assertTrue(lockMan.holdsLock("A", 1, LockManager.LockType.SHARED)); //T1 should now have shared lock
    assertFalse(lockMan.holdsLock("A", 2, LockManager.LockType.EXCLUSIVE)); //T2 still did not obtain shared lock
